...
class Animal {
    constructor(name, gender, size, age, vaccine, img) {
        this.name = name;
        this.gender = gender;
        this.size = size;
        this.age = age;
...
class Cat extends Animal {
    constructor(name, gender, size, age, vaccine, img, breed, furColor, breedInformation, breedName) {
        super(name, gender, size, age, vaccine, img);
        this.breed = breed;
        this.furColor = furColor;
        this.breedInformation = breedInformation;
...
class Dog extends Animal {
    constructor(name, gender, size, age, vaccine, img, breed, training) {
        super(name, gender, size, age, vaccine, img);
        this.breed = breed;
...
let vaccineEL = document.getElementsByClassName("vaccine-container");
let vaccineIconEL = document.getElementsByClassName("vaccine-icon");
