...
<nav class="navbar navbar-admin p-5 navbar-expand-lg navbar-dark bg-light mb-5">
        <div class="container-fluid">
            ...
            <img class="adm-picture userImage img-thumbnail rounded-circle" src="../img/<?php echo $row_adm['picture']; ?>" alt="<?php echo $row_adm['fname']; ?>" class="d-inline-block align-text-top">
